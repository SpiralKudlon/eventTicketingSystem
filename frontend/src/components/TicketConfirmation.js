...
/**
 * TicketConfirmation Component - Enhanced with toast notifications
 * Displays ticket confirmation with QR code
 */
function TicketConfirmation() {
    ...
    // Show success toast on mount if ticket data exists
    useEffect(() => {
        if (ticketData) {
            showSuccess('🎉 Ticket purchased successfully! Check your email for confirmation.');
        } else {
            showWarning('No ticket data found. Please purchase a ticket first.');
        }
    }, [ticketData, showSuccess, showWarning]);
